...
df_train = pd.read_csv('../data/inputs/train.csv')
df_test = pd.read_csv('../data/inputs/test.csv')
...
df_outlier_prob["outlier_prob"] = predictions
...
# In case missing some predictable outlier, we choose top 25000 with highest outliers likelihood.
