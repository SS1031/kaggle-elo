...
test = pd.read_feather(os.path.join(CONST.INDIR, "test.feather"))

target = train['target']
del train['target']

historical_transactions['month_diff'] = \
    (CONST.REFDATE - historical_transactions['purchase_date']).dt.days // 30
historical_transactions['month_diff'] += historical_transactions['month_lag']

new_transactions['month_diff'] = ((CONST.REFDATE - new_transactions['purchase_date']).dt.days) // 30
