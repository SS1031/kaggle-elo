...
class _602_RecentAggregate(FeatureBase):
    ...
    pref = "_602_new-hist_recent5_agg_"
    ...
    def create_feature_impl(self, df_list, random_state):
        ...
        df = df.sort_values('purchase_date').groupby(['card_id']).tail(5)
...
if __name__ == '__main__':
    trn, tst = _602_RecentAggregate().create_feature(devmode=True)
